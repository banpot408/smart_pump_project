...
//  Serial.print("Timer_Config comma_posi_1 : ");
//  Serial.print(comma_posi_1);
//  Serial.print(" Value : ");
  String progran_num = Timer_Config.substring(0, comma_posi_1);
//  Serial.println(progran_num);


//  Serial.print("Timer_Config comma_posi_2 : ");
//  Serial.print(comma_posi_2);
  String program1_on_hour_st = Timer_Config.substring(comma_posi_1+1, comma_posi_2);
//  Serial.print(" Value : ");
//  Serial.println(program1_on_hour_st);
//
//  Serial.print("Timer_Config comma_posi_3 : ");
//  Serial.print(comma_posi_3);
  String program1_on_minute_st = Timer_Config.substring(comma_posi_2+1, comma_posi_3);
//  Serial.print(" Value : ");
//  Serial.println(program1_on_minute_st);
//
//  Serial.print("Timer_Config comma_posi_4 : ");
//  Serial.print(comma_posi_4);
  String program1_on_second_st = Timer_Config.substring(comma_posi_3+1, comma_posi_4);
//  Serial.print(" Value : ");
//  Serial.println(program1_on_second_st);
//  
//  Serial.print("Timer_Config comma_posi_5 : ");
//  Serial.print(comma_posi_5);
  String program1_off_hour_st = Timer_Config.substring(comma_posi_4+1, comma_posi_5);
//  Serial.print(" Value : ");
//  Serial.println(program1_off_hour_st);
//  
//  Serial.print("Timer_Config comma_posi_6 : ");
//  Serial.print(comma_posi_6);
  String program1_off_minute_st = Timer_Config.substring(comma_posi_5+1, comma_posi_6);
//  Serial.print(" Value : ");
//  Serial.println(program1_off_minute_st);
//  
//  Serial.print("Timer_Config comma_posi_7 : ");
//  Serial.print(comma_posi_7);
  String program1_off_second_st = Timer_Config.substring(comma_posi_6+1, comma_posi_7);
//  Serial.print(" Value : ");
//  Serial.println(program1_off_second_st);
//  
//  Serial.print("Timer_Config comma_posi_8 : ");
//  Serial.println(comma_posi_8);
  String program1_ctl_op_st = Timer_Config.substring(comma_posi_7+1, comma_posi_8);
//  Serial.print(" Value : ");
//  Serial.println(program1_ctl_op_st);
//  
//  Serial.print("Timer_Config comma_posi_9 : ");
//  Serial.println(comma_posi_9);
  String program1_enable_st = Timer_Config.substring(comma_posi_8+1, comma_posi_9);
//  Serial.print(" Value : ");
//  Serial.println(program1_enable_st);
...
//  Serial.print("line 3 Status : ");
//  Serial.print(readLine(myFile, line3, sizeof(line3)));
//  Serial.print(" Value : ");
